...
public class Application {
    public static void main(String[] args) {
        // reflect란?
        // 컴파일된 자바 코드에서 역으로 클래스를 불러 메소드 및 필드 정보를 구해온는 방법을 제공한다.
        // 반사, 투영이라는 의미를 가진다.
        // 스프링, 마이바이트, 하이버네이트 등의 라이브러리에서 사용한다.

        // 주의사항
        // 1. 오버헤드 발생 : 성능저하를 발생할 수 있기 때문에 성능에 민감한 애플리케이션은 사용하지 않는다.
        // 2. 캘슐화 저해 : private 로 설정한 member에 직접적으로 접근할 수 있기 때문에 코드 기능이 저하되며 여러가지 문제를 야기시킨다.
        ...
        try {
            ...
            Class class05 = double[].class;
            System.out.println("class5: " + class05);
